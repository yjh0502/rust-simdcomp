...
($out:ident, $i:ident, $mul:expr, $( [ $( $idx:expr ),* ] ),* ) => { {
    ...
    unsafe {
        $({
            ...
            let mut pullbits = 32 - shift;
            if(pullbits > 0) {
                *($out.get_unchecked_mut(destidx)) |=
                    x86::sse2_pslli_d(*($i.get_unchecked(srcidx)), pullbits) & mask;
            }
            srcidx += 1;
        })*
    }
...
fn test_pack() {
    let input = [
        i32x4(1, 0, 1, 0), i32x4(1, 0, 1, 0), i32x4(1, 0, 1, 0), i32x4(1, 0, 1, 0),
        i32x4(1, 0, 1, 0), i32x4(1, 0, 1, 0), i32x4(1, 0, 1, 0), i32x4(1, 0, 1, 0),
        i32x4(1, 0, 1, 0), i32x4(1, 0, 1, 0), i32x4(1, 0, 1, 0), i32x4(1, 0, 1, 0),
        i32x4(1, 0, 1, 0), i32x4(1, 0, 1, 0), i32x4(1, 0, 1, 0), i32x4(1, 0, 1, 0),
        i32x4(1, 0, 1, 0), i32x4(1, 0, 1, 0), i32x4(1, 0, 1, 0), i32x4(1, 0, 1, 0),
...

    {
        ...
        assert_eq!(output[0].0, 0b11111111111111111111111111111111);
        assert_eq!(output[0].1, 0);
        assert_eq!(output[0].2, 0b11111111111111111111111111111111);
...

    {
        ...
        assert_eq!(output[1].0, 0b10010010010010010010010010010010);
        assert_eq!(output[1].1, 0);
        assert_eq!(output[1].2, 0b10010010010010010010010010010010);
        assert_eq!(output[1].3, 0);
